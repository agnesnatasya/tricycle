...
# cv_2 = contextvars.ContextVar("cv_2")
# import random
# value_set_initially = 20
# async def main():
#     def thread_task(value_for_nursery):
#         print(trio.from_thread.run_sync(lambda: None))
#         data = local()
#         data.x = random.randint(1, 10)
#         print(trio.from_thread.run_sync(cv_2.get))
#         print(contextvars.copy_context()[cv_2])
...
cv_3 = contextvars.ContextVar("cv_3")
import random
value_set_initially = 20
async def main():
...
cv_4 = contextvars.ContextVar("cv_4")
